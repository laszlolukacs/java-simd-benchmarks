...
class ArrayAverageCalculatorTest {
    ...
    @Test
    void average2ScalarEqualsToSimd() {
        double[] scalarResult = ArrayAverageCalculator.average2Scalar(arrayA, arrayB);
        double[] simdResult = ArrayAverageCalculator.average2Simd(arrayA, arrayB);
        assertArrayEquals(scalarResult, simdResult);
    }
}